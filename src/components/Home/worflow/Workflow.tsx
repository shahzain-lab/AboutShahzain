...
const Workflow = () => {
    return (
        <div className='bg-black py-6 text-white relative'>
            <img src={wave__page} alt='bg-lines' className='absolute w-full mt-10 md:top-64 md:rotate-90' />
            ...
            <div className='bg-cover pr-20 w-full mx-14 my-16 flex justify-around md:flex-col items-center'>
                ...
                <div className='md:w-full w-1/5 border-2 bg-neutral-900 p-2 rounded-lg mb-8 border-slate-800'>
                    ...
                    <h3>Reviews</h3>
                    <p>After development,when your app is ready to be deploy I again test and reviews all the features that i built and then in time.</p>
                </div>
            </div>
