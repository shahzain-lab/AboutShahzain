    ...
    return (
        <div className='bg-black text-white relative'>
            ...
            <div className='w-full text-center'>
                ...
                <h2 className='text-4xl z-10  text-slate-300 font-["Open_Sans"] capitalize '>My Workflow process</h2>
            </div>
            <div className='bg-cover pr-20 w-full mx-14 my-16 flex justify-around items-center'>
                ...
                <div className='w-1/5 border-2 z-10 bg-neutral-900 p-2 rounded-lg mb-8 border-slate-800'>
                ...
                <div className='z-10 w-1/5 border-2 bg-neutral-900 p-2 rounded-lg mb-8 border-slate-800'>
