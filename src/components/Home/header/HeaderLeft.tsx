...
const HeaderLeft = ({ data }: IAbout) => {
  ...
  return (
    ...
    <main className='flex flex-col justify-center items-center w-1/2 md:w-full mb-40 md:mt-40 md:mb-2'>
      <div className='pl-4'>
      ...
      <div className='flex md:mt-4 justify-items-start md:justify-center items-center w-full'>
        <button className="px-4 md:px-2 py-2 ml-6 text-white font-semibold rounded bg-fuchsia-600 hover:bg-fuchsia-700">Visit Projects <span className="">&#8594;</span></button>
