...
const Navbar = () => {
    ...
    return (
        <nav className="flex lg:flex-col justify-between bg-slate-700 items-center w-full h-20">
                ...
                <button className='hidden lg:flex rounded-lg mr-6 focus:outline-none focus:shadow-outline'>
                    {
                        state === 'open' ? (
                            <svg fill="currentColor" onClick={() => setState('!open')} viewBox="0 0 20 20" className="w-10 h-10">
                                <path x-show="!open" fill="#fff" fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM9 15a1 1 0 011-1h6a1 1 0 110 2h-6a1 1 0 01-1-1z" clip-rule="evenodd"></path>
                            </svg>

                        )
                            : (
                                <svg fill="currentColor" viewBox="0 0 20 20" onClick={() => setState('open')} className="w-10 h-10">
                                    <path x-show="open" fill="#fff" fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                            )
                    }
                </button>
            ...
            {
                state === '!open' ? (
                    <div className="flex justify-between transition-all items-center z-10 w-1/2 lg:rounded-xl lg:mx-4 cursor-pointer text-zinc-300 font-normal text-lg lg:text-center lg:h-40 lg:flex-col lg:w-full lg:mt-6 lg:bg-gray-700">
