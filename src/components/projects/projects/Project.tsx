        ...
        <div className='w-[45%] shadow-2xl text-center rounded-2xl m-6 text-white bg-zinc-900'>
            ...
            <div className='flex w-full justify-between'>
                <div className='w-2/5 ml-6 p-4 mb-4  text-left shadow-inner rounded-xl bg-gray-800'>
                    <h2 className='text-xl text-transparent bg-clip-text bg-gradient-to-br from-teal-500 to-violet-500 font-bold'>{node.title}</h2>
                    <h4 className='mt-4'>{renderRichText(node.description)}</h4>
                </div>
                <div className='w-3/5'>
                    <div className='bg-gradient-to-r from-teal-500 to-violet-500 mb-4 mt-2 mx-2 rounded-xl'>

                        <GatsbyImage
                            alt={node.title}
                            image={Image}
                            className='mx-auto opacity-30 w-full'
                        />
                    </div>
